// Tiny isomorphic HTML-entity decoder.
// Allegro returns message bodies with HTML entities (&quot;, &oacute;, &lstrok;…)
// that we want to render as Unicode. Keeps the curated map small but covers
// XML 5, common typography, and Polish/Latin-1 accented letters.
...
const NAMED: Record<string, string> = {
	...
	// Latin-1 accented (uppercase + lowercase)
	...
	szlig: 'ß',
	// Polish-specific (HTML4 names + a few common variants)
