...
-- AddForeignKey
ALTER TABLE "VideoSessionChunk" ADD CONSTRAINT "VideoSessionChunk_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "VideoPlaybackSession"("id") ON DELETE CASCADE ON UPDATE CASCADE;
